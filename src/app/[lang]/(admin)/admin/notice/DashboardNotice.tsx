...
import { deleteDashboardNotice } from "@/server/actions/notice/dashboard.action";

const DashboardNotice = async () => {
  await connectDB();
  const data = await DashboardModel.find().sort({ createdAt: -1 });
  ...
  return (
    <div className="w-full">
      <div className="pb-2">
        ...
        <Link
          href="/admin/notice/new/dashboard"
              ...
              <TableRow key={d._id}>
                ...
                <TableCell className="text-right">
                  <div className="inline-flex gap-2">
                    ...
                    <DeleteAlert
                      deleteAction={deleteDashboardNotice}
